...
class ProfileCreateShema(BaseModel):
    first_name: str
    last_name: str
    gender: str
    date_of_birth: date
    ...
    @classmethod
    def validate_name_fields(cls, name: str) -> str:
        try:
            validate_name(name)
            return name.lower()
...
class ProfileResponseShema(BaseModel):
    id: int
    user_id: int
    first_name: str
    last_name: str
